            ...
            <div class="col-lg-3">
              <div class="card mb-3 text-center">
                ...
                <div class="card-body">
                  ...
                  Role : <b><?php echo ucfirst(
                      $_SESSION['user_role']
                  ); ?></b><hr>
                  <form action="statuschange.php" method="POST">
                    <input type="hidden" id="staffid" name="staffid" value=" <?php echo $_SESSION[
                        'uid'
                    ]; ?>" />
                      <?php if (getStatus() == 'Online') {
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Food Ordering System 2021</span>
            </div>
          </div>
        </footer>
